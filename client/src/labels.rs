...
fn attach_initial_labels(
    ...
    q_station: Query<Entity, With<crate::scene::greybox::StationRoom>>,
    q_tunnel: Query<Entity, With<crate::scene::flow_field::Tunnel>>,
    q_chamber: Query<Entity, With<crate::scene::greybox::Chamber>>,
